        ...
        <div className="sm:text-7xl text-6xl bg-gradient-to-r from-blue-600 to-purple-500 inline-block text-transparent bg-clip-text font-bold">
          ...
          <div>
            ...
            <div className="font-normal flex items-center justify-center lg:justify-normal gap-4 mt-3 ">
              <a href="https://github.com/felipeB21" target="_blank" className="group text-lg bg-purple-600 text-white flex items-center gap-2 w-max px-4 py-1 rounded-full outline-none focus:scale-105 hover:bg-purple-700 transition duration-300">
                GitHub <BsGithub 
                  className="group-hover:translate-x-1.5 transition"
                />
              </a>
